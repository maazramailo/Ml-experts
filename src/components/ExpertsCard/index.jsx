...
import LinkedIn from "@/image/Home/LinkedIn2.svg";
...
function Card({
    ...
    return (
        <div
            className={`shadow-custom pb-[4rem] h-[25rem] md:h-[25rem] lg:h-[26rem] mt-20 md:mt-20 lg:mt-28 xl:mt-20 xl:h-[29rem]   w-full  pt-4 relative rounded-[30px] ${className} relative hover:shadow-lg`}
            ...
            <div className="flex items-baseline absolute top-4 right-4">
                ...
                >
                    <Image
                        ...
                        alt="LinkedIn"
                        title="LinkedIn"
                        className={`transition-transform transform ${isHovered ? "scale-150 rounded" : "scale-100"
                            }`}
                    />
                </a>
            </div>
            <div className="flex flex-col justify-between mt-20">
                <div className="pt-2 xl:pt-0 w-full px-4 text-center ">

...
function BlackBox() {
    ...
    return (
        <div className="justify-center items-center w-full flex flex-col gap-6 md:gap-12  mt-40 " id="services">
            <div className="justify-center items-center  flex flex-col w-[90%] gap-3">
                ...
                <p className="text-center text-[#676767] font-normal text-sm xl:text-lg w-[95%] md:w-[60%] xl:leading-[32px]  md:pb-5">
                    From ideation to execution, our broad spectrum of deep tech services
                    ensures all your technological needs are met efficiently and
                    effectively.
                </p>
            </div>
                ...
                <div className="flex flex-col md:flex-row w-full justify-evenly gap-5 md:gap-4 ">
                            ...
                            <div key={index}>
                                ...
                                >
                                    <div className="text-white mt-4 md:hidden">
                                        ...
                                        <p className="text-xs font-normal leading-[26px] text-[#C5C5C5]">
                                            {item.description}
                                        </p>
                                        <Image
                    ...
                    <div className="md:min-w-[70%] min-w-[100%] text-white hidden md:block">
                        <div className="xl:px-10 px-1 flex flex-col gap-3 md:mt-2">
                            ...
                            <p className="text-xs xl:text-base font-normal md:w-[93%] w-full md:pr-6 leading-[26px] md:leading-[30px] xl:leading-9 text-[#C5C5C5]">
